...
-(void)renderAsVectorInContext:(CGContextRef)context
{
    ...
    if ( xValueData.numberOfSamples != yValueData.numberOfSamples ) {
        [NSException raise:CPTException format:@"Number of x and y values do not match... %lu-%lu",(unsigned long)xValueData.numberOfSamples, (unsigned long)yValueData.numberOfSamples];
    }
